...
export function getSandboxService(sessionId: string, agentId: string, userId: string): BaseSandboxService {
    ...
    return new SandboxSdkClient(sessionId, agentId, userId);
}